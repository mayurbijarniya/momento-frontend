...
import { useCreateReview, useUpdateReview } from "@/lib/react-query/queriesAndMutation";
...
const ReviewForm = ({
      ...
      updateReview(
        {
          ...
          review: { review: review.trim(), rating: rating || undefined },
        },
        {
          onSuccess: () => {
            toast({
  ...
  const renderStarRating = () => {
    return (
      <div className="flex gap-1 mb-2">
        ...
        {rating > 0 && (
          <span className="small-regular text-light-3 ml-2">
            ({rating}/5)
          </span>
        )}
      </div>
  ...
  return (
    <form onSubmit={handleSubmit} className="p-4 border border-dark-4 rounded-lg bg-dark-2">
      <div className="mb-3">
