        ...
        <div className="flex items-center gap-3">
          {isAuthenticated ? (
            ...
            <div className="flex items-center gap-2">
              <Link href="/sign-in" className="flex items-center justify-center gap-2 px-4 py-3 text-white hover:bg-dark-4 rounded-lg transition-all duration-200 border border-dark-4">
                <LogOut className="h-5 w-5" strokeWidth={2} />
                <span className="text-sm base-medium">Sign-in</span>
              </Link>
              <Link href="/sign-up" className="flex items-center justify-center gap-2 px-4 py-3 text-white hover:bg-dark-4 rounded-lg transition-all duration-200 border border-dark-4 bg-dark-4">
                <LogOut className="h-5 w-5" strokeWidth={2} />
