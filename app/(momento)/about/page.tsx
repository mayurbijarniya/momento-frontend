...
const AboutPage = () => {
  ...
  const teamMembers = [
    { name: "Mayur Mahavir Bijarniya", section: "Section 05" },
    { name: "Niraj Mehta", section: "Section 05" },
  ];
  ...
  const repositories = [
    {
      ...
      url: "https://github.com/mayurbijarniya/momento-frontend",
    },
    {
      title: "Backend Repository",
      url: "https://github.com/mayurbijarniya/momento-backend",
    },
  ];
          ...
          <div className="space-y-3">
            {repositories.map((repo, index) => (
              <a
                ...
                className="flex items-center gap-3 p-4 bg-dark-4 border border-border rounded-lg hover:bg-secondary/50 transition-colors"
              >
                <Github className="h-5 w-5 text-muted-foreground" />
                <div>
                  <p className="font-medium text-foreground">{repo.title}</p>
