...
export const useLikePost = () => {
    ...
    return useMutation({
        ...
        onSuccess: (data) => {
            queryClient.invalidateQueries({
                queryKey: [QUERY_KEYS.GET_POST_BY_ID, (data as any)?.$id || (data as any)?.id]
            })
            queryClient.invalidateQueries({
                queryKey: [QUERY_KEYS.GET_RECENT_POSTS]
            })
...
export const useGetPosts = () => {
    return useInfiniteQuery({
      ...
      getNextPageParam: (lastPage: any) => {
        ...
        const lastId = lastPage.documents[lastPage.documents.length - 1].$id || (lastPage.documents[lastPage.documents.length - 1] as any).id;
        return lastId;
      },
...
export const useUpdateUser = () => {
    ...
    return useMutation({
        ...
        onSuccess: (data) => {
            ...
            queryClient.invalidateQueries({
                queryKey: [QUERY_KEYS.GET_USER_BY_ID, (data as any)?.$id || (data as any)?.id],
            });
        },
    });
};
